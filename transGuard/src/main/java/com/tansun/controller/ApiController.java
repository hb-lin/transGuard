...
public class ApiController {
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/register/registe", method = RequestMethod.POST)
...
//        }
     ...
     * @throws IOException
     */
    @RequestMapping(value = "/register/delete_api", method = RequestMethod.POST)
...
//        }
        ...
        JSONObject jsonObject = new JSONObject()
                .fluentPut("status", code)
                .fluentPut("message", "success")
                .fluentPut("result", new JSONObject().fluentPut("apiId", "delete"+count));
        response.setContentType("text/plain; charset=UTF-8");
        try {
            response.getWriter().print(jsonObject);
        } catch (IOException e) {
